...
public class CardDataBase 
{
    ...
    { 
        cards.Add(new Card("King of monkey", "when you summon beast during the battle, your creatures getting +1 attack until end of the turn", 4, 4, 3, 99, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.AfterSummon },Card.Race.Beast, Resources.Load<Sprite>("beast-kingofmonkey")));//>>>>..?
        ...
        cards.Add(new Card("Beef Oni", "This cost 3 health instead of gold to buy", 4, 3, 2, 9, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.AfterBuying }, Card.Race.Demon, Resources.Load<Sprite>("Demon-beefyoni")));
        ...
        cards.Add(new Card("Patrones OF the Underworld", "<b>After death</b>", 4, 4, 4, 19, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.AfterHisDeath }, Card.Race.Demon, Resources.Load<Sprite>("Demon-PatronessoftheUnderworld")));
