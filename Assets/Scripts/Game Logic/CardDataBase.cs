...
public class CardDataBase 
{
    ...
    { 
        ...
        cards.Add(new Card("Forest Warior", "-", 1, 2, 0, 1, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.BattleCry }, Card.Race.Beast, Resources.Load<Sprite>("Beast-ForestWarrior")));//added
        ...
        cards.Add(new Card("Sentient Owl", "-", 1, 1, 0, 5, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.AfterDeath}, Card.Race.Beast, Resources.Load<Sprite>("Beast-SentientOwl")));//должна призывать два 1/1 зверя
        ...
        cards.Add(new Card("Sand Vortex", "after turn this sells for 1 more Gold", 2, 1, 0, 2, new List<Card.CardSpeciallAbility> { Card.CardSpeciallAbility.AtTheEndOFTheTimer}, Card.Race.Elemental, Resources.Load<Sprite>("Elem-SandVortex")));//add f string
